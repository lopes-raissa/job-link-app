...
class Datasource {
    ...
    companion object {
        fun getPublications(): ArrayList<Publication>{
            ...
            publications.add(Publication(3, "Fernando Henrique", "11/05/2021","Elestricista","kfgkdegpkdfgpkdef Publicação no Appkfgkdegpkdfgpkdef Publicação no Appkfgkdegpkdfgpkdef Publicação no Appkfgkdegpkdfgpkdef Publicação no Appkfgkdegpkdfgpkdef Publicação no App", 5.0f))
        ...
        fun getCategory(): ArrayList<Category>{
            ...
            categories.add(Category(1, "Eletricista"))
            categories.add(Category(2, "Mecanico"))
            categories.add(Category(3, "Diarista"))
            categories.add(Category(4, "Advogado"))
            categories.add(Category(5, "Pedreiro"))
            categories.add(Category(6, "Baba"))
